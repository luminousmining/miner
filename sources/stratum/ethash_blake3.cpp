...
#include <stratum/ethash_blake3.hpp>


void stratum::StratumEthashBlake3::onResponse(
...
void stratum::StratumEthashBlake3::onMiningNotify(
    boost::json::object const& root)
{
    ////////////////////////////////////////////////////////////////////////////
...
void stratum::StratumEthashBlake3::onMiningSetDifficulty(
    boost::json::object const& root)
{
    boost::json::array const& params(root.at("params").as_array());
...
void stratum::StratumEthashBlake3::onMiningSetTarget(
    boost::json::object const& root)
{
    boost::json::array const& params(root.at("params").as_array());
...
void stratum::StratumEthashBlake3::onMiningSetExtraNonce(
    boost::json::object const& root)
{
    boost::json::array const& params(root.at("params").as_array());
...
void stratum::StratumEthashBlake3::miningSubmit(
