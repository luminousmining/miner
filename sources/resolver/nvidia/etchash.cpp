...
resolver::ResolverNvidiaEtchash::ResolverNvidiaEtchash() : resolver::ResolverNvidiaEthash()
{
    algorithm = algo::ALGORITHM::ETCHASH;
}


bool resolver::ResolverNvidiaEtchash::updateContext(stratum::StratumJobInfo const& jobInfo)
{
    ///////////////////////////////////////////////////////////////////////////
