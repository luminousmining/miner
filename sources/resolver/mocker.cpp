...
bool resolver::ResolverMocker::updateMemory([[maybe_unused]] stratum::StratumJobInfo const& jobInfo)
{
    ///////////////////////////////////////////////////////////////////////////
    ...
    {
        resolverInfo() << "Update memory force waiting: " << *config.toolConfigs.mockerResolverUpdateMemorySleep
                       << "ms";
...
bool resolver::ResolverMocker::updateConstants([[maybe_unused]] stratum::StratumJobInfo const& jobInfo)
{
...
bool resolver::ResolverMocker::executeSync([[maybe_unused]] stratum::StratumJobInfo const& jobInfo)
{
...
bool resolver::ResolverMocker::executeAsync([[maybe_unused]] stratum::StratumJobInfo const& jobInfo)
{
...
void resolver::ResolverMocker::submit([[maybe_unused]] stratum::Stratum* const stratum)
{
}


void resolver::ResolverMocker::submit([[maybe_unused]] stratum::StratumSmartMining* const stratum)
{
}
