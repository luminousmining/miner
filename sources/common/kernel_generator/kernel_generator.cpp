...
void common::KernelGenerator::setKernelName(std::string const& kernelFunctionName)
{
    kernelName.assign(kernelFunctionName);
}


void common::KernelGenerator::addInclude(std::string const& pathInclude)
{
    includes.push_back(pathInclude);
}


void common::KernelGenerator::declareDefine(std::string const& name)
{
    defines[name].clear();
}


void common::KernelGenerator::appendLine(std::string const& line)
{
    sourceCode += line;
    sourceCode += "\n";
}
...
bool common::KernelGenerator::appendFile(std::string const& pathFileName)
{
...
void common::KernelGenerator::writeKernelInFile(std::string const& source, std::string const& extension)
{
