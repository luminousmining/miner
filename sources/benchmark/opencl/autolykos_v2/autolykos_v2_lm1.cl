// =============================================================================
// Autolykos v2 - AMD throughput benchmark kernel (self-contained snapshot).
//
// Byte-for-byte copy of the production search assembly (autolykos_v2_result +
// rotate_byte + blake2b + autolykos_v2_var_global + autolykos_v2_search) with the
// entry point renamed `autolykos_v2_lm1`, so the benchmark exercises a frozen copy
// and never the live mining kernel. The NONCES_PER_ITER / THREADS_PER_ITER /
// NONCE_SIZE_32 / NUM_SIZE_32 macros are supplied by the benchmark driver via -D,
// exactly as ResolverAmdAutolykosV2 does.
// =============================================================================
