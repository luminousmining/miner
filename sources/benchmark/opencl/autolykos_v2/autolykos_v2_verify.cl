// =============================================================================
// Autolykos v2 - AMD verify benchmark kernel (self-contained snapshot of
// autolykos_v2_result + rotate_byte + blake2b + autolykos_v2_var_global +
// autolykos_v2_verify). Frozen copy, decoupled from the production kernel tree.
// =============================================================================
