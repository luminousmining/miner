...
uint2 const keccak_round_constants[24]
{
...
// void ethash_keccak_f1600_init(uint2* state)
// {
//     uint2 s[25];
//     uint2 t[5], u, v;
...
//     devectorize<uint4, uint2, uint2>(d_header[0], s[0], s[1]);
//     devectorize<uint4, uint2, uint2>(d_header[1], s[2], s[3]);
//     s[4] = state[4];
//     s[5] = make_uint2(1, 0);
//     s[6] = u2zero;
//     s[7] = u2zero;
...
// __device__ __forceinline__
// uint64_t ethash_keccak_f1600_final(uint2* state)
// {
//     uint2 s[25];
//     uint2 t[5];
//     uint2 u;
//     uint2 v;
//     uint2 const u2zero = make_uint2(0, 0);
...
//     return devectorize<uint2>(s[0] ^ keccak_round_constants[23]);
// }
