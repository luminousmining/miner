...
__global__
void kernel_keccak_f800_lm7()
{
    uint32_t flat_matrix[25];

    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00000001u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008082u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x0000808au;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x80008000u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x0000808bu;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x80000001u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x80008081u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008009u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x0000008au;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00000088u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x80008009u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x8000000au;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x8000808bu;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x0000008bu;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008089u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008003u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008002u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00000080u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x0000800au;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x8000000au;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x80008081u;
    keccak_f800_round_lm7(flat_matrix); flat_matrix[0] ^= 0x00008080u;
}


__host__
bool keccak_f800_lm7(
    cudaStream_t stream,
    uint32_t const blocks,
    uint32_t const threads)
{
    kernel_keccak_f800_lm7<<<blocks, threads, 0, stream>>>();
