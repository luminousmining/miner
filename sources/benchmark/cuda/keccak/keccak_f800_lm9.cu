    ...
    uint32_t* const __restrict__ out)
{
    ...
    // Theta - Compute all d0-d4 first to avoid reusing tmp 5 times
    bc[0] = xor5(out, 0u);
    bc[1] = xor5(out, 1u);
    bc[2] = xor5(out, 2u);
    bc[3] = xor5(out, 3u);
    ...
    // Chi - Manually unroll loop to avoid overhead and i * 5u computation at each iteration
...
__global__
void kernel_keccak_f800_lm9()
{
    uint32_t flat_matrix[25];

    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00000001u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008082u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x0000808au;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x80008000u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x0000808bu;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x80000001u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x80008081u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008009u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x0000008au;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00000088u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x80008009u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x8000000au;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x8000808bu;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x0000008bu;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008089u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008003u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008002u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00000080u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x0000800au;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x8000000au;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x80008081u;
    keccak_f800_round_lm9(flat_matrix); flat_matrix[0] ^= 0x00008080u;
}


__host__
bool keccak_f800_lm9(
    cudaStream_t stream,
    uint32_t const blocks,
    uint32_t const threads)
{
    kernel_keccak_f800_lm9<<<blocks, threads, 0, stream>>>();
