    ...
    uint4&                              v_2)
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    uint32_t const hv_1 = hashes[i_1]; __threadfence_block();
    uint32_t const hv_2 = hashes[i_2]; __threadfence_block();
    uint32_t const hv_3 = hashes[i_3]; __threadfence_block();
    uint32_t const hv_4 = hashes[i_4]; __threadfence_block();
    uint32_t const hv_5 = hashes[i_5]; __threadfence_block();
    uint32_t const hv_6 = hashes[i_6]; __threadfence_block();
    uint32_t const hv_7 = hashes[i_7]; __threadfence_block();
    uint32_t const hv_8 = hashes[i_8]; __threadfence_block();
...
__global__
void __launch_bounds__(64, 64)
kernel_autolykos_v2_step_2_lm2(
    uint32_t const* const __restrict__ hashes,
    ...
    uint64_t const                     nonce)
{
    ...
    r[0] = BHashes[tid           ]; __threadfence_block();
    r[1] = BHashes[8388608  + tid]; __threadfence_block();
    r[2] = BHashes[16777216 + tid]; __threadfence_block();
    r[3] = BHashes[25165824 + tid]; __threadfence_block();
    r[4] = BHashes[33554432 + tid]; __threadfence_block();
    r[5] = BHashes[41943040 + tid]; __threadfence_block();
    r[6] = BHashes[50331648 + tid]; __threadfence_block();
    r[7] = BHashes[58720256 + tid]; __threadfence_block();
    ...
    uint32_t const period)
{
    ...
    kernel_autolykos_v2_step1_lm2<<<blocks / 4u, threads, 0, stream>>>
    (
        dag,
        (uint64_t*)header,
        BHashes,
    ...
    kernel_autolykos_v2_step_2_lm2<<<blocks, threads, 0, stream>>>
    (
        dag,
        BHashes,
        result,
