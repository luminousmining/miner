    ...
    uint32_t const     sel)
{
    ...
    switch (sel % 4u)
    {
        ...
        case 1u:
            ...
            break;
        case 2u:
            ss << "\t" << ret << "rol_u32(" << l << ", " << (((sel >> 16) % 31) + 1) << ") ^ " << r << ";\n";
            break;
        case 3u:
            ss << "\t" << ret << "ror_u32(" << l << ", " << (((sel >> 16) % 31) + 1) << ") ^ " << r << ";\n";
            break;
    }
}
    ...
    uint32_t const     sel_merge)
{
    ...
    {
        case 0u:
            ss << "\t" << ret << "__clz(" << l << ") + __clz(" << r << ")"
               << ";\n";
            break;
        case 1u:
            ss << "\t" << ret << "__popc(" << l << ") + __popc(" << r << ")"
               << ";\n";
            break;
        case 2u:
            ss << "\t" << ret << l << " + " << r << ";\n";
    ...
    switch (sel_merge % 4u)
    {
        ...
        case 1u:
            ...
            break;
        case 2u:
            ss << "\t" << ret << "rol_u32(" << l << ", " << (((sel_merge >> 16) % 31) + 1) << ") ^ " << r << ";\n";
            break;
        case 3u:
            ss << "\t" << ret << "ror_u32(" << l << ", " << (((sel_merge >> 16) % 31) + 1) << ") ^ " << r << ";\n";
            break;
    }
}
    ...
    uint32_t const     sel)
{
    ...
    ss << "\t"
       << "// iter[" << i << "] merge " << sel % 4 << "\n";
    ss << "\t"
       << "dag_offset = mix[" << src << "] & " << (algo::progpow::MODULE_CACHE - 1) << "u"
       << ";\n";
    ...
    uint32_t const               moduleSource)
{
    ...
    pathSequenceMath /=
        "sequence_math_random"s + "_"s + std::to_string(deviceId) + "_"s + std::to_string(period) + ".cuh"s;
    ...
    for (auto i{ 0u }; i < max; ++i)
    {
        ...
        if (i < countCache)
        {
            ...
            switch (progpowVersion)
            {
                ...
                case algo::progpow::VERSION::V_0_9_4:
                    algo::progpow::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::KAWPOW:
                    algo::kawpow::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::MEOWPOW:
                    algo::meowpow::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::FIROPOW:
                    algo::firopow::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::EVRPROGPOW:
                    algo::evrprogpow::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::PROGPOWQUAI:
                    algo::progpow_quai::nvidia::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
            }
        }
        ...
        if (i < countMath)
        {
            ...
            switch (progpowVersion)
            {
                ...
                case algo::progpow::VERSION::V_0_9_3: /* algo::progpow::VERSION::V_0_9_4*/
                case algo::progpow::VERSION::V_0_9_4:
                    algo::progpow::nvidia::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::KAWPOW:
                    algo::kawpow::nvidia::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::MEOWPOW:
                    algo::meowpow::nvidia::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::FIROPOW:
                    algo::firopow::nvidia::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::EVRPROGPOW:
                    algo::evrprogpow::nvidia::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::PROGPOWQUAI:
                    algo::progpow_quai::nvidia::writeSequenceMathMerge(
                        ss,
                        i,
                        castU32(dstValue),
                        src1,
