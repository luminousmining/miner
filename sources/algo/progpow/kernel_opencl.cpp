    ...
    for (uint32_t i{ 0u }; i < max; ++i)
    {
        ...
        if (i < countCache)
        {
            ...
            switch (progpowVersion)
            {
                ...
                case algo::progpow::VERSION::V_0_9_4:    progpow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel); break;
                ...
                case algo::progpow::VERSION::QUAIPOW:    quaipow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel); break;
            }
        }
        ...
        if (i < countMath)
        {
            ...
            switch (progpowVersion)
            {
                case algo::progpow::VERSION::V_0_9_2:    /* algo::progpow::VERSION::V_0_9_4 */
                case algo::progpow::VERSION::V_0_9_3:    /* algo::progpow::VERSION::V_0_9_4 */
                case algo::progpow::VERSION::V_0_9_4:    progpow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2); break;
                ...
                case algo::progpow::VERSION::QUAIPOW:    quaipow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2); break;
            }
        }
    }
