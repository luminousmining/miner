    ...
    uint32_t const     sel)
{
    ...
    ss << "\t"
       << "// iter[" << i << "] merge " << sel % 4 << "\n";
    ss << "\t"
       << "dag_offset = hash[" << src << "] & " << (algo::progpow::MODULE_CACHE - 1) << "u"
       << ";\n";
    ...
    uint32_t const               moduleSource)
{
    ...
    pathSequenceMath /=
        "sequence_math_random"s + "_"s + std::to_string(deviceId) + "_"s + std::to_string(period) + ".cl"s;
    ...
    for (uint32_t i{ 0u }; i < max; ++i)
    {
        ...
        if (i < countCache)
        {
            ...
            switch (progpowVersion)
            {
                ...
                case algo::progpow::VERSION::V_0_9_4:
                    amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::KAWPOW:
                    kawpow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::MEOWPOW:
                    meowpow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::FIROPOW:
                    firopow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::EVRPROGPOW:
                    evrprogpow::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
                case algo::progpow::VERSION::PROGPOWQUAI:
                    progpow_quai::amd::writeSequenceMergeCache(ss, i, srcValue, dstValue, sel);
                    break;
            }
        }
        ...
        if (i < countMath)
        {
            ...
            switch (progpowVersion)
            {
                ...
                case algo::progpow::VERSION::V_0_9_3: /* algo::progpow::VERSION::V_0_9_4 */
                case algo::progpow::VERSION::V_0_9_4:
                    amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::KAWPOW:
                    kawpow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::MEOWPOW:
                    meowpow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::FIROPOW:
                    firopow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::EVRPROGPOW:
                    evrprogpow::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
                case algo::progpow::VERSION::PROGPOWQUAI:
                    progpow_quai::amd::writeSequenceMathMerge(ss, i, castU32(dstValue), src1, src2, sel1, sel2);
                    break;
            }
        }
    }
