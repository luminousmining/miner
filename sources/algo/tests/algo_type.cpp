...
TEST_F(AlgoTypeTest, stringToEnumSuccess)
{
    ...
    EXPECT_EQ(algo::toEnum("quaipo"),       algo::ALGORITHM::QUAIPOW);
...
TEST_F(AlgoTypeTest, stringToEnumFail)
{
    ...
    EXPECT_NE(algo::toEnum("quaipo"),       algo::ALGORITHM::EVRPROGPOW);
    EXPECT_NE(algo::toEnum("autolykosv2"),  algo::ALGORITHM::QUAIPOW);
